...
{
    /// <summary>
    /// Interface do serviço responsável pelas operações de negócio relacionadas à entidade Estado.
    /// Define os contratos para obtenção de estados e seus dados associados (como municípios).
    /// </summary>
